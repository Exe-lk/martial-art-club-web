...
type CounterItem = {
  icon: string;
  value: string;
  labelKey: "medals" | "champions" | "students" | "years" | "branches";
};
...
const COUNTERS: CounterItem[] = [
  ...
  { icon: "location_city", value: "6+", labelKey: "branches" },
];
  ...
  return (
    <section ref={sectionRef} className="bg-black py-16 md:py-20">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-10 md:gap-12 text-center">
          {parsed.map((item, idx) => (
